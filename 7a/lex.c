...
} itab[] =
{
	...
	"STLXP",	LTYPE1,	ASTLXP,
	"STLXR",	LTYPE1,	ASTLXR,
	"STLXRB",	LTYPE1,	ASTLXRB,
	"STLXRH",	LTYPE1,	ASTLXRH,
	"STLXRW",	LTYPE1,	ASTLXRW,
	"SUB",	LTYPE1,	ASUB,
	"SUBS",	LTYPE1,	ASUBS,
	"SUBSW",	LTYPE1,	ASUBSW,
	"SUBW",	LTYPE1,	ASUBW,
...
/*
	...
	"LDARH",	LTYPE1,	ALDARH,
	"LDARW",	LTYPE1,	ALDARW,
	"LDAXPW",	LTYPE1,	ALDAXPW,
	"LDAXR",	LTYPE1,	ALDAXR,
	"LDAXRB",	LTYPE1,	ALDAXRB,
	"LDAXRH",	LTYPE1,	ALDAXRH,
	"LDAXRW",	LTYPE1,	ALDAXRW,
*/
	...
	"FMOVD",		LTYPE3, AFMOVD,
	"FMOVDS",		LTYPE3, AFMOVDS,
	"FMOVDW",	LTYPE3, AFMOVDW,
	"FMOVS",		LTYPE3, AFMOVS,
	"FMOVSD",		LTYPE3, AFMOVSD,
	"FMOVSW",		LTYPE3, AFMOVSW,
	"FMOVWD",	LTYPE3, AFMOVWD,
	"FMOVWS",		LTYPE3, AFMOVWS,
